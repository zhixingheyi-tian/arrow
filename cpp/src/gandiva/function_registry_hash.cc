...
#define HASH_SHA1_NULL_IF_NULL_FN(name, ALIASES) \
  NUMERIC_BOOL_DATE_VAR_LEN_TYPES(HASH_SHA1_NULL_IF_NULL, name, ALIASES)

#define HASH_SHA2_NULL_IF_NULL_FN(name, ALIASES) \
  NUMERIC_BOOL_DATE_VAR_LEN_TYPES(HASH_SHA2_NULL_IF_NULL, name, ALIASES)

#define HASH_SHA256_NULL_IF_NULL_FN(name, ALIASES) \
  NUMERIC_BOOL_DATE_VAR_LEN_TYPES(HASH_SHA256_NULL_IF_NULL, name, ALIASES)

#define HASH_MD5_NULL_IF_NULL_FN(name, ALIASES) \
  NUMERIC_BOOL_DATE_VAR_LEN_TYPES(HASH_MD5_NULL_IF_NULL, name, ALIASES)
...
std::vector<NativeFunction> GetHashFunctionRegistry() {
  static std::vector<NativeFunction> hash_fn_registry_ = {
      ...
      HASH_SHA1_NULL_IF_NULL_FN(hashSHA1, {"sha1"}),

      HASH_SHA2_NULL_IF_NULL_FN(hashSHA2, {"sha2"}),

      HASH_SHA256_NULL_IF_NULL_FN(hashSHA256, {"sha256"}),

      HASH_MD5_NULL_IF_NULL_FN(hashMD5, {"md5"})};
